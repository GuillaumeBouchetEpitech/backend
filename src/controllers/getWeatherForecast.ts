...
export const getWeatherForecast = async (req: express.Request, res: express.Response) => {
    ...
    try {
        ...
        const data = await models.openweathermapApi.getWeatherForecast(latitude, longitude);
